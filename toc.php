...
Customization:  2020-09-02T1440+0200 (support for HTML/CSS scroll offset: l. 1402..1403)
Functionality:  2020-09-03T1110+0200 (toc backlinks on CSS heading numbers: l. 1202, 1231, 1235, 1389, 1391, 1402..1403, 1539)
Security:       2020-09-05T2008+0200 (abort if file is run directly: l. 48)
I18n:           2020-09-06T2229+0200 (fixed defective anchor URL generation: l. 1145..1148, 1157..1161, 1176)
Source code:    2020-09-08T0422+0200 (interspersed newlines for code layout)
Last modified:  2020-09-26T2327+0200
*/
...
<?php
		...
		private function url_anchor_target( $title )
		{
			...
			if ( $title ) {
				...
				// fallback fragment identifier   (deleted original 2 lines of comment)
				if ( !$return ) {
